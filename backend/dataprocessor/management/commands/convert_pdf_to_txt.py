...
class Command(BaseCommand):
    help = 'Convert PDF files to TXT in the graphrag input media folder and its subfolders'

    def handle(self, *args, **options):
        input_dir = os.path.join(settings.BASE_DIR, 'graphrag', 'input', 'media')
        output_base_dir = os.path.join(settings.BASE_DIR, 'graphrag', 'input', 'txt_files')
